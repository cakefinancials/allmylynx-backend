export function BOTTLE_FACTORY(container) {
  ...
  const logger = container[BOTTLE_NAMES.LIB_LOGGER].getContextualLogger('get_user_state_bag.handler');
  ...
  const SERVICE = {
    ...
    handler: async (event, context, callback) => {
      try {
        ...
        logger.createAndLogWrappedError(CONSTANTS.GET_USER_STATE_BAG_ERROR, CONSTANTS.FAILURE_MESSAGE, e, {
          event,
          context,
        });
